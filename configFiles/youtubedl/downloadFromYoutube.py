...
#      fileNameWithPath = os.path.join(path, fileName)
#      metadataID = EasyID3(path+'/'+fileName)
...
#        results = ydl.extract_info(url)
  ...
  for x in range(len(songsTitleList)):
     ...
     trackNumber+=1
     add_metadata(trackNumber, playlistName, songName)
